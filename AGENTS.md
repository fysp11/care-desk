...
This project is indexed by GitNexus as **care-desk** (3249 symbols, 5395 relationships, 89 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
