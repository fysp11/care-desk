...
| 6. Optional stretch | Medium/High | Docker Compose, cloud hosting, audit log, rate limiting, richer UI polish. | Only attempted after phases 1-5 are stable and verified. |
